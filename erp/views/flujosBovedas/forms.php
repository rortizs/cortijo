        ...
        <section class="panel">
            <div class="panel-body">
                <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                    <label>Sala</label>
                    <select id="idSalas" class="form-control input-sm" onchange="getFormSala();">
                    </select>
                </div>
                <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                ...
                <div class="col-lg-6">
                    <label>&nbsp;</label><br/>
                    <button type="button" class="btn btn-info btn-sm" onclick="consultarCierre();" title="Consultar Cierre">
                        <span class="fa fa-search"></span>
                    </button>
                    <button type="button" class="btn btn-primary btn-sm" onclick="guardarArqueo();" id="save" title="Guardar Cierre">
                        <span class="fa fa-floppy-o"></span>
                    </button>
                    <button type="button" class="btn btn-warning btn-sm" onclick="updateArqueo();" id="update" title="Actualizar Cierre">
                        <span class="fa fa-refresh"></span>
                    </button>
                    <button type="button" class="btn btn-danger btn-sm" onclick="cancelUpdateArqueo('1');" id="cancel" title="Eliminar Cierre">
    ...
    <thead>
        ...
        <tr>
            ...
            <td style="width: 5% !important;">
                <button class="btn btn-primary btn-sm" onclick="addRow('formArqueo1');">
...
<table id="formArqueo2" class="table table-striped table-bordered" cellspacing="0" width="100%">
    <thead>
        ...
        <tr>
            ...
            <td style="width: 10% !important;">Valor</td>
            <td style="width: 5% !important;">
                <button class="btn btn-primary btn-sm" onclick="addRow('formArqueo2');">
                    <i class="fa fa-plus"></i>
                </button>
            </td>
        </tr>
...
<table id="formArqueo3" class="table table-striped table-bordered" cellspacing="0" width="100%">
    <thead>
        ...
        <tr>
            ...
            <td style="width: 10% !important;">Valor</td>
            <td style="width: 5% !important;">
                <button class="btn btn-primary btn-sm" onclick="addRow('formArqueo3');">
                    <i class="fa fa-plus"></i>
                </button>
            </td>
        </tr>
...
<table id="formArqueo4" class="table table-striped table-bordered" cellspacing="0" width="100%">
    <thead>
        ...
        <tr>
            ...
            <td style="width: 10% !important;">Valor</td>
            <td style="width: 5% !important;">
                <button class="btn btn-primary btn-sm" onclick="addRow('formArqueo4');">
                    <i class="fa fa-plus"></i>
                </button>
            </td>
        </tr>
