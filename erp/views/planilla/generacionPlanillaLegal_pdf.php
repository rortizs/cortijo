...
foreach ($getHrmDepartamentos as $key => $value) {
    $html .= '<table cellspacing="0" style="width: 1460px !important;">
            <thead>
            	<tr>
    ...
    foreach ($generacionPlanilla as $key2 => $value2) {
        ...
        $html .= '<td style="border:1px solid #000; text-align:right;">' . number_format($totalBonos, 2) . '</td>';
        if ($_REQUEST['fuenteHorasExtras'] == 1) {
