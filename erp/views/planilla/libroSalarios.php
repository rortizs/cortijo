        ...
        <section class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        &nbsp;<br/>
                        <button class="btn btn-primary btn-sm" onclick="generarLibroSalarios();">
                            <i class="fa fa-table"></i> Generar Libro de Salarios
                        </button>
                    </div>
                </div>
            </div>
                            ...
                            <table class="table table-striped table-bordered table-hover" cellspacing="0" style="width: 1843px !important;">
                                ...
                                <tbody>
                                    ...
                                    foreach ($generacionPlanilla as $key2 => $value2) {
                                        ...
                                        $seguroSocial = 0;
                                        $totalPagado = ($value2['ordinario'] + $value2['bonificacion'] + $value2['bonificacionFija'] + ($totalDiurnas * ($value2['salarioDiarioHE'] / 8) * 1.5) + ($totalNocturnas * ($value2['salarioDiarioHE'] / 8) * 2) + $value2['horasExtMixtas'] + $value2['comisiones'] + $value2['bonoIncentivo'] + $value2['bonoCalidad'] + $value2['bonoProductividad'] + $value2['bonoFlocking'] + $value2['otrosPagos']);
                                        $totalPagado2 = ($value2['ordinario'] + ($totalDiurnas * ($value2['salarioDiarioHE'] / 8) * 1.5) + ($totalNocturnas * ($value2['salarioDiarioHE'] / 8) * 2) + $value2['horasExtMixtas']);
