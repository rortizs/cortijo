...
$img = 'assets/images/empleados/' . $getRecord['image'];
if (!$getRecord['image']) {
            ...
            <div class="panel-body profile-information">
                <div class="col-md-3">
                    <div class="profile-pic text-center">
                        ...
                        <input type="hidden" id="idHrmEmpleados" value="<?= $_REQUEST['value']; ?>"/>
                    </div>
                    <center>
                        <button onclick="subirFotoFicha();" id="btnUpload" class="btn btn-primary btn-sm" style="width: 50% !important;">
                ...
                <div class="col-lg-9">
                    <div class="profile-desk">
                        <h1>
                            <?= $getRecord['primerNombre']; ?> <?= $getRecord['segundoNombre']; ?> <?= $getRecord['tercerNombre']; ?>
                            <?= $getRecord['primerApellido']; ?> <?= $getRecord['segundoApellido']; ?> <?= $getRecord['apellidoCasada']; ?>
                        </h1>
                        <br/>
                        <b>Estado:</b> <?= $getRecordView['idHrmStatusEmpleado']; ?><br/>
                        <b>Departamento:</b> <?= $getRecordView['idHrmDepartamentos']; ?>/ <b>Puesto:</b> <?= $getRecordView['idHrmPuestos']; ?>
                    </div>
                    <div class="clear">&nbsp;</div>
                    <div class="col-lg-12">
                        <?php
        ...
        <section class="panel">
            <header class="panel-heading tab-bg-dark-navy-blue">
                <ul class="nav nav-tabs nav-justified ">
                    <li class="active">
                        <a data-toggle="tab" href="#datosEmpleado">
                            <i class="fa fa-user"></i> Datos Empleado
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a data-toggle="tab" href="#datosExpediente" onclick="hrmEmpleadosExpediente();">
                            <i class="fa fa-archive"></i> Expediente
                        </a>
                    </li>
                </ul>
            </header>
            <div class="panel-body">
                <div class="tab-content tasi-tab">
                    <div id="datosEmpleado" class="tab-pane active">
                        <div class="row">
                            <?= $group1; ?>
                        </div>
                    </div>
                    ...
                    <div id="datosExpediente" class="tab-pane ">
                        <div class="row">
                            <div class="row">
                                <div class="col-lg-5">
                                    <label>Nombre</label>
                                ...
                                <div class="col-lg-2">
                                    &nbsp;<br/>
                                    <button class='btn btn-primary btn-sm' onclick='subirExpediente();'>
