...
$img = 'assets/images/productos/' . $getRecord['image'];
if (!$getRecord['image']) {
            ...
            <div class="panel-body profile-information">
                <div class="col-md-3">
                    <div class="profile-pic text-center">
                        ...
                        <input type="hidden" id="idProductos" value="<?= $_REQUEST['value']; ?>"/>
                    </div>
                    <center>
                        <button onclick="subirFotoFichaProducto();" id="btnUpload" class="btn btn-primary btn-sm" style="width: 50% !important;">
                ...
                <div class="col-lg-9">
                    <div class="profile-desk">
                        <h1>
                            Codigo: <?= $getRecord['sku']; ?><br/>
                            Nombre: <?= $getRecord['descLarga']; ?>
                        </h1>
                        <br/>
                        <b>Costo:</b> <?= $getRecord['precioCosto']; ?><br/>
                        <b>Precio Venta:</b> <?= $getRecord['precioPublico']; ?>
                    </div>
                    <div class="clear">&nbsp;</div>
                    <div class="col-lg-12">
                        <?php
        ...
        <section class="panel">
            <header class="panel-heading tab-bg-dark-navy-blue">
                <ul class="nav nav-tabs nav-justified ">
                    ...
                    <!--
                    <li>
                        <a data-toggle="tab" href="#componentes" onclick="loadComponentes();">
                            <i class="fa fa-briefcase"></i> Componentes
                        </a>
                    </li>
                    -->
                    <li>
                        <a data-toggle="tab" href="#codigosAlternos" onclick="loadCodigosAlternos();">
                            <i class="fa fa-briefcase"></i> Codigos Alternos
                        </a>
                    </li>
<!--                    <li>
                        <a data-toggle="tab" href="#productosEquivalencias" onclick="loadProductosEquivalencias();">
                            <i class="fa fa-list-ol"></i> Equivalencias de Inventario
                        </a>
                    </li>
                    <li>
                        <a data-toggle="tab" href="#contabilidad" onclick="loadProductosContabilidad();">
                            <i class="fa fa-briefcase"></i> Contabilidad
                        </a>
                    </li>
                    <li>
                        <a data-toggle="tab" href="#historialCostos">
                            <i class="fa fa-briefcase"></i> Historial de Costos
                        </a>
                    </li>-->
                </ul>
            </header>
            <div class="panel-body">
                <div class="tab-content tasi-tab">
                    ...
                    <div id="componentes" class="tab-pane ">
                    </div>
                    <div id="codigosAlternos" class="tab-pane ">
                    </div>
<!--                    <div id="productosEquivalencias" class="tab-pane ">
                    </div>
                    <div id="referenciasPersonales" class="tab-pane ">
                    </div>
                    <div id="contabilidad" class="tab-pane ">
                    </div>
                    <div id="historialCostos" class="tab-pane ">
                    </div>-->
                </div>
            </div>
        </section>
