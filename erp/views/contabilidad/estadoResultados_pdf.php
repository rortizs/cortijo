...
$xml = simplexml_load_file("../jasper/estadoResultados.jrxml");
...
$PHPJasperXML->arrayParameter = array("idEmpresas" => $_SESSION['idEmpresa'], "periodoInicial" => $_REQUEST['yearInicial'], "periodoFinal" => $yearFinal, "mesInicial" => $_REQUEST['mesInicial'], "mesFinal" => $mesFinal);
