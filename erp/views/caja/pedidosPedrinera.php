                ...
                <section class="panel">
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <label>Maquina</label>
                                <select class="form-control input-sm" id="idMaquinas"></select>
                            </div>
                            <div class="col-lg-3">
                                <label>Transporte</label>
                                <select class="form-control input-sm" id="idTransportista"></select>
                            </div>
                            <div class="col-lg-3">
                                <label>Nombre Piloto</label>
                                <input type="text" class="form-control input-sm pedidos" value="" id="piloto" tabindex="3"/>
                            </div>
                            <div class="col-lg-3">
                                <label>Placa Unidad</label>
                                <input type="text" class="form-control input-sm pedidos" value="" id="placa" tabindex="3"/>
                            </div>
                            <div class="col-lg-12">
